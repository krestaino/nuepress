<template>
  <div class="author">
    <div class="articles">
      ...
      <article-list :articles="authorArticles.articles" />
      <infinite-loading v-if="(authorArticles.infiniteLoading)  && (authorArticles.articles.length >= 10)" :on-infinite="moreArticles" ref="infiniteLoading"/>
    </div>
